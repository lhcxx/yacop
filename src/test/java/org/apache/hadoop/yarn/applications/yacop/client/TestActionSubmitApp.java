...
import org.apache.hadoop.yarn.applications.yacop.client.ActionSubmitApp;
...
public class TestActionSubmitApp {
  ...
  private static YacopConfig yacopConfig;
  ...
  private static void mockYacopConfig() {
    ...
    yacopConfig = mock(YacopConfig.class, withSettings().serializable());
  ...
  private void setActionField(Object action) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
    Field yacopConfigField = action.getClass().getDeclaredField("yacopConfig");
    yacopConfigField.setAccessible(true);
    yacopConfigField.set(action, yacopConfig);
