...
public class YacopConfig implements Serializable {
    ...
    private YacopConfig(Builder builder) {
    ...
    public String toString() {
        StringBuilder yacopConfig = new StringBuilder()
        ...
        if(this.engineConfig.getNetworkConfig() != null) {
            yacopConfig.append("engine_network_mode: " + this.engineConfig.getNetworkConfig().getMode() + "\n");
            yacopConfig.append("engine_network_name: " + this.engineConfig.getNetworkConfig().getName() + "\n"); 
        }

        for (VolumeConfig vc : this.engineConfig.getVolumeConfigs()) {
            yacopConfig.append("engine_volume_containerPath: " + vc.getContainerPath() + "\n")
                         .append("engine_volume_hostPath: " + vc.getHostPath() + "\n")
                         .append("engine_volume_mode: " + vc.getMode() + "\n");
        }
        return yacopConfig.toString();
    }
    ...
    static class Builder {
        ...
        synchronized YacopConfig build() throws BuilderException {
            if (this.name == null)
